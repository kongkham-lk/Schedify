        ...
        try {
            ...
            for (int i = 0; i < registeredCourseList.length(); i++) {
                try {
                    ...
                    CourseModel course = new CourseModel(R.drawable.gradient_color_3, courseCode, room,startTime,endTime,courseTitle, isRegistered, startDate,
                            endDate,roomNumber, classDayList, urlID);
